...
Dazu liegt Datentabelle einer freiwilligen und anoymen Online-Umfrage unter FOM Studierenden in ausgewählten Fächern und Standorten vor.

```{r einlesen}
# Daten einlesen
film <- read.csv2(here::here("data", "film.csv"))
# Datenstruktur
str(film)
```
...
- Anhand welcher Abbildung können Sie am Besten erkennen welche Gruppe (Intereesse an Horrorfilmen Ja oder Nein) sich eher für Komödien interessiert?
...
- Wird der Prozentsatz derjenigen, die sich für Komödien interessieren, die sich auch für Horrorfilme interessieren genau so hoch sein?
